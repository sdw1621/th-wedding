 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Qg=Et("X",[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]]);function Hg(){const[a,n]=Ss(),[r,l]=ye.useState(null),u=["/th-wedding/img/pages/KakaoTalk_20260305_230912710.png","/th-wedding/img/pages/KakaoTalk_20260305_232813657.png","/th-wedding/img/pages/clip1772719635985.png","/th-wedding/img/pages/clip1772719933405.png","/th-wedding/img/pages/clip1772719961777.png","/th-wedding/img/pages/clip1772720241909.png","/th-wedding/img/pages/clip1772720265226.png","/th-wedding/img/pages/clip1772720440413.png","/th-wedding/img/pages/clip1772720601331.png","/th-wedding/img/pages/clip1772721300357.png"];return I.jsxs("section",{className:"py-24 bg-white overflow-hidden",id:"gallery",ref:a,children:[I.jsxs("div",{className:`max-w-2xl mx-auto transition-all duration-1000 ${n?"opacity-100 translate-y-0":"opacity-0 translate-y-10"}`,children:[I.jsxs("div",{className:"text-center mb-8 px-6",children:[I.jsx(lp,{className:"mx-auto text-rose-200 mb-4",size:28,strokeWidth:1.5}),I.jsx("h2",{className:"text-xl font-serif tracking-widest text-stone-800 font-bold",children:"우리의 빛나는 순간"}),I.jsx("p",{className:"text-xs text-stone-500 mt-3 animate-pulse font-medium",children:"사진을 누르면 크게 보실 수 있어요 📸"})]}),I.jsx("div",{className:"flex overflow-x-auto snap-x snap-mandatory hide-scrollbar px-6 space-x-4 pb-8",children:u.map((f,m)=>I.jsx("div",{className:"flex-none w-[80vw] sm:w-[300px] snap-center",children:I.jsxs("div",{className:"rounded-xl overflow-hidden shadow-sm aspect-[4/5] cursor-zoom-in group relative",onClick:()=>l(f),children:[I.jsx("img",{src:f,alt:`Gallery ${m+1}`,className:"w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"}),I.jsx("div",{className:"absolute inset-0 bg-black/0 group-hover:bg-black/10 transition-colors"})]})},m))})]}),r&&I.jsxs("div",{className:"fixed inset-0 z-[60] bg-black/95 flex items-center justify-center p-4 animate-in fade-in duration-300",onClick:()=>l(null),children:[I.jsx("button",{className:"absolute top-8 right-8 text-white p-2",onClick:()=>l(null),children:I.jsx(Qg,{size:32})}),I.jsx("img",{src:r,alt:"Zoomed",className:"max-w-full max-h-[85vh] object-contain rounded-lg shadow-2xl animate-in zoom-in-95 duration-300"})]})]})}/**
 * @license lucide-react v0.460.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
